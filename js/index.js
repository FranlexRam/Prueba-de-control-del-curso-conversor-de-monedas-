...
select.insertAdjacentHTML("beforeend",`<option value="0.87">Libras esterlinas</option>`)
select.insertAdjacentHTML("beforeend",`<option value="370.22">Pesos argentinos</option>`)
select.insertAdjacentHTML("beforeend",`<option value="4510.51">Pesos colombianos</option>`)
select.insertAdjacentHTML("beforeend",`<option value="19.33">Pesos mexicanos</option>`)